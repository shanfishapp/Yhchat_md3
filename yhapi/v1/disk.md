    ...
    "list": [
      {
        ...
        "name": "114514", // 文件名称
        "fileSize": 0, // 文件大小
        "objectType": 1, // 对象类型，1-文件夹，2-文件
        "uploadTime": 1754534188, // 更新时间
        "uploadBy": "114514", // 上传者id
        "uploadByName": "上传者名称",
        "qiniuKey": "" // 七牛云密钥（文件夹为空，如果是文件，则value一般为https://chat-file.jwznb.com/disk/xxxxxxxxxxxxxxxxxxxx [无文件后缀名，下载后该文件名改成key:name的value值]需要请求头加 referer:https://myapp.jwznb.com 才能下载）
      }
     // ...
    ]
  },
